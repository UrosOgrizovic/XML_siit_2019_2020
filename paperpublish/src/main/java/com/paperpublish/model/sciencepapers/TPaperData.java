 ...
 *         &lt;element name="Reviewer" type="{http://localhost:8080/SciencePapers}TReviewers" maxOccurs="unbounded"/>
...
public class TPaperData {
    ...
    protected List<TReviewers> reviewer;
     ...
     * 
     */
    public List<TReviewers> getReviewer() {
        if (reviewer == null) {
            reviewer = new ArrayList<TReviewers>();
        }
