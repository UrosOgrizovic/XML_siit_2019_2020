...
export class SciencePaperFormComponent implements OnInit {
  ...
  // xmlSciencePaperContent: string = "<Papers:SciencePaper versionId='1' documentId='' xmlns:Papers='http://localhost:8080/SciencePapers'></Papers:SciencePaper>";
  xmlSciencePaperContent = "<Papers:SciencePaper versionId='1' documentId='' xmlns:Papers='http://localhost:8080/SciencePapers'><Papers:PaperData numberOfReferences='3' contact='sava@gmail.com' numberOfDownloads='3'><Papers:ShortTitle property='pred:shortTitle' xml:space='preserve'>NEKI TAJTL</Papers:ShortTitle><Papers:Author><Papers:authorUserName property='pred:authorUserName' xml:space='preserve'>user</Papers:authorUserName></Papers:Author><Papers:DocumentLink xml:space='preserve'>neki link</Papers:DocumentLink></Papers:PaperData><Papers:Paragraf><Papers:content xml:space='preserve'>PARAGRAAAAAAAF</Papers:content></Papers:Paragraf></Papers:SciencePaper>";
